			...
			<div class="col-lg-12 col-md-12">
				<section class="tile color transparent-black">
					<div class="tile-header">
						<h1><strong>Add</strong> Position</h1>
					</div>
					...
					<div class="tile-body">
						...
						{{ Form::open(array('url' => '/position', 'method' => 'post', 'class' => 'form-horizontal', 'role' => 'form', 'parsley-validate' => '', 'id' => 'basicvalidation')) }}

							<div class="form-group">
								<label for="name" class="col-sm-4 control-label">Name *</label>
								<div class="col-sm-6">
									{{ Form::text('name', '', array('class' => 'form-control', 'id' => 'name', 'parsley-trigger' => 'change', 'parsley-required' => 'true', 'style' => 'text-transform: capitalize')) }}
								</div>
							</div>
